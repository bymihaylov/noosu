...
class TimingPoint():
    def __init__(self, time: int, beat_len: float, meter: int, sample_set: int, sample_index: int, volume: int, uninherited: bool, effects: enum.IntFlag):
        self._time = time
